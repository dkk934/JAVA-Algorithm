...
// It works for both directed and undirected graphs and handles negative weights (no negative cycles).
public class FloydWarshall {
    ...
    public static void floydWarshall(int[][] graph) {
        ...
        // Update dist matrix by considering all vertices as intermediate points
        for (int k = 0; k < V; k++) {
            for (int i = 0; i < V; i++) {
                for (int j = 0; j < V; j++) {
